...
const grades = [
  { label: "Novice", desc: "Jeune diplômé ou reconversion. Accompagné par un mentor WAL.", color: "var(--laiton)" },
  { label: "Confirmé", desc: "2 ans d'expérience minimum. Évaluations clients solides.", color: "var(--laiton-texte)" },
  { label: "Expert", desc: "Maîtrise technique avancée. Spécialisation reconnue.", color: "var(--laiton-texte)" },
  { label: "Maître", desc: "Excellence absolue. Sélection sur dossier et évaluation centre WAL.", color: "var(--nuit)" },
];
...
export default function CoiffeurPage() {
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-3xl">
            ...
            >
              Votre talent.
              <br />
              <em style={{ fontStyle: "italic", color: "var(--laiton)" }}>Votre liberté.</em>
            </h1>
            ...
            <p className="text-white/50 text-sm mt-8">
              Déjà partenaire ?{" "}
              <Link href="/pro" className="text-[var(--laiton)] hover:text-white transition-colors underline underline-offset-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            >
              ...
              <br />
              <em style={{ fontStyle: "italic", color: "var(--laiton)" }}>pour votre succès.</em>
            </h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#E3DCC9]">
            {avantages.map((item) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              ...
              <br />
              <em style={{ fontStyle: "italic", color: "var(--laiton)" }}>Gagnez plus.</em>
            </h2>
          ...
          <div className="flex flex-col divide-y divide-[#E3DCC9]">
            {grades.map((grade, i) => (
              <div key={grade.label} className="flex flex-col sm:flex-row items-start sm:items-center gap-6 py-8">
                <span
                  className="text-[#E3DCC9] w-16 shrink-0"
                  style={{
                    fontFamily: "var(--font-cormorant), Georgia, serif",
                    fontSize: "56px",
                    fontWeight: 300,
                    lineHeight: 1,
                    color: i === 3 ? "var(--laiton)" : undefined,
                  }}
                >
      ...
      {/* Offre de lancement */}
      <section className="bg-[var(--nuit)] py-20 px-6">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
          <p className="sep text-[var(--laiton)]/60 text-xs" style={{ letterSpacing: "0.3em" }}>
            OFFRE DE LANCEMENT
          </p>
          <h2
          ...
          >
            ...
            <br />
            <em style={{ fontStyle: "italic", color: "var(--laiton)" }}>d&apos;avantages exclusifs.</em>
          </h2>
          ...
          <Link
            href="/contact"
            className="mt-4 px-8 py-4 bg-[var(--laiton)] text-[var(--nuit)] text-xs tracking-[0.2em] hover:bg-[#BFA070] transition-colors duration-300"
          >
          ...
          <form className="flex flex-col gap-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[var(--nuit)] outline-none focus:border-[var(--laiton)] transition-colors"
            ...
            <div className="flex flex-col gap-2">
              ...
              <select className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[var(--nuit)] outline-none focus:border-[var(--laiton)] transition-colors appearance-none">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                rows={3}
                className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[var(--nuit)] outline-none focus:border-[var(--laiton)] transition-colors resize-none"
                placeholder="Coupe, couleur, balayage, soins kératine..."
              />
            </div>
            <button
              type="submit"
              className="mt-2 bg-[var(--nuit)] text-white text-xs tracking-[0.2em] py-4 hover:bg-[var(--laiton)] hover:text-[var(--nuit)] transition-colors duration-300"
            >
