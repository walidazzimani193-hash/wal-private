...
const grades = [
  { label: "Novice", desc: "Jeune diplômé ou reconversion. Accompagné par un mentor WAL.", color: "#A9885A" },
  { label: "Confirmé", desc: "2 ans d'expérience minimum. Évaluations clients solides.", color: "#8A6D43" },
  { label: "Expert", desc: "Maîtrise technique avancée. Spécialisation reconnue.", color: "#8A6D43" },
  { label: "Maître", desc: "Excellence absolue. Sélection sur dossier et évaluation centre WAL.", color: "#11241B" },
];
...
export default function CoiffeurPage() {
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="min-h-[56vh] md:min-h-[75vh] bg-[#11241B] flex items-end pb-20 md:pb-24 px-6 pt-36">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-3xl">
            ...
            >
              Votre talent.
              <br />
              <em style={{ fontStyle: "italic", color: "#A9885A" }}>Votre liberté.</em>
            </h1>
            ...
            <p className="text-white/50 text-sm mt-8">
              Déjà partenaire ?{" "}
              <Link href="/pro" className="text-[#A9885A] hover:text-white transition-colors underline underline-offset-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            >
              ...
              <br />
              <em style={{ fontStyle: "italic", color: "#A9885A" }}>pour votre succès.</em>
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              ...
              <br />
              <em style={{ fontStyle: "italic", color: "#A9885A" }}>Gagnez plus.</em>
            </h2>
      ...
      {/* Offre de lancement */}
      <section className="bg-[#11241B] py-20 px-6">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          >
            ...
            <br />
            <em style={{ fontStyle: "italic", color: "#A9885A" }}>d&apos;avantages exclusifs.</em>
          </h2>
          ...
          <Link
            href="/contact"
            className="mt-4 px-8 py-4 bg-[#A9885A] text-[#11241B] text-xs tracking-[0.2em] hover:bg-[#BFA070] transition-colors duration-300"
          >
          ...
          <form className="flex flex-col gap-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input
                  type="text"
                  className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[#11241B] outline-none focus:border-[#A9885A] transition-colors"
            ...
            <div className="flex flex-col gap-2">
              ...
              <select className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[#11241B] outline-none focus:border-[#A9885A] transition-colors appearance-none">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                rows={3}
                className="bg-white border border-[#E3DCC9] px-4 py-3.5 text-sm text-[#11241B] outline-none focus:border-[#A9885A] transition-colors resize-none"
                placeholder="Coupe, couleur, balayage, soins kératine..."
              />
            </div>
            <button
              type="submit"
              className="mt-2 bg-[#11241B] text-white text-xs tracking-[0.2em] py-4 hover:bg-[#A9885A] hover:text-[#11241B] transition-colors duration-300"
            >
